...
const NIASS_PRODUCTS = [
  { id: 1,  name: "",                        category: "femme",   price: 25000, oldPrice: 32000, image: "https://placehold.co/600x800/16233F/FAF5EC?text=Boubou+Wax",        images: ["https://placehold.co/600x800/16233F/FAF5EC?text=Boubou+Wax","https://placehold.co/600x800/24365C/FAF5EC?text=Vue+2","https://placehold.co/600x800/B8432E/FAF5EC?text=Vue+3"], sizes:["S","M","L","XL"], colors:["#16233F","#B8432E","#D9A441"], badge:"promo", popularity: 92, rating:4.6, desc:"Boubou en tissu wax authentique, coupe fluide et confortable, idéal pour les grandes occasions. Motifs colorés tissés avec finitions cousues main." },
  { id: 2,  name: "Chaussures de Tendance",  category: "homme",   price: 10000, image: "/assets/images/chaussure H.png", images:["/assets/images/chaussure H.png", "/assets/images/chaussur H1.png"], sizes:["41","42","43","44","45"], colors:["#F0E4CC","#0e0e0e"], badge:"new", popularity: 78, rating:4.3, desc:"Chaussures de tendance facile à porter et léger pour des sortie et aux alentours de la maison ." },
  { id: 3,  name: "Chaussures Haute",        category: "femme",   price: 9000, image: "/assets/images/chaussure F.png", images: ["/assets/images/chaussure F.png", "/assets/images/chaussure F.png"], sizes:["39","40","41"], colors:["#050403","#f3f4f7"], badge:"new", popularity: 88, rating:4.8, desc:"Chaussure femme haut niveau avec des talons exceptionnel" },
